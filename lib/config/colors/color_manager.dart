...
class ColorManager {
  ...
  static const Color lowOpacityGrey = Color.fromARGB(113, 62, 62, 47);
  ...
  static const Color naveBlue = Color(0XFF002333);
  static const Color green = Colors.green;
  static const Color lightGreen = Color(0xFFDEEFE7);

  static const Color darkBlue = Color.fromARGB(255, 4, 113, 238);
  static const Color purple = Color.fromARGB(255, 160, 4, 238);
  static const Color lightBlue = Color(0xFFDEEFE7);
