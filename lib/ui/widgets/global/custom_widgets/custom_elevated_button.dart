...
import '../../../../config/colors/color_manager.dart';
...
class CustomElevatedButton extends StatefulWidget {
  ...
  const CustomElevatedButton({Key? key, required this.isItDone, this.blueColor = true, this.isThatSignIn = false, required this.nameOfButton, required this.onPressed})
      : super(key: key);
...
class _CustomElevatedButtonState extends State<CustomElevatedButton> {
  ...
  Widget circularProgress() {
    return const Center(
      child: SizedBox(height: 20, width: 20, child: CircularProgressIndicator(color: ColorManager.white, strokeWidth: 2)),
    );
  }

  BoxDecoration containerStyle() {
    return BoxDecoration(
      color: !widget.blueColor ? ColorManager.lightBlue : (widget.isItDone ? ColorManager.blue : ColorManager.lightBlue),
